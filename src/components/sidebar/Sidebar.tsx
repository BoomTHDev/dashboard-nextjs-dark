...
export default function Sidebar() {
    ...
    return (
        ...
        <aside className={`-translate-x-full flex flex-col justify-between bg-slate-800 fixed inset-y-0 left-0 z-50 w-64 overflow-y-auto transition-transform duration-300 ease-in-out transform ${
